...
export function plannerStyles({ T, preferences }) {
  return `
        ...
        .nb-nav-motion-mask>[data-nav-mask="top-left"]{left:var(--nav-mask-left);top:var(--nav-mask-top);border-bottom-right-radius:var(--nav-mask-radius);transform:translate3d(calc(-1 * (var(--nav-mask-left) + var(--nav-mask-radius))),calc(-1 * (var(--nav-mask-top) + var(--nav-mask-radius))),0)}
        .nb-nav-motion-mask>[data-nav-mask="top-right"]{right:var(--nav-mask-right);top:var(--nav-mask-top);border-bottom-left-radius:var(--nav-mask-radius);transform:translate3d(calc(var(--nav-mask-right) + var(--nav-mask-radius)),calc(-1 * (var(--nav-mask-top) + var(--nav-mask-radius))),0)}
        .nb-nav-motion-mask>[data-nav-mask="bottom-left"]{left:var(--nav-mask-left);bottom:var(--nav-mask-bottom);border-top-right-radius:var(--nav-mask-radius);transform:translate3d(calc(-1 * (var(--nav-mask-left) + var(--nav-mask-radius))),calc(var(--nav-mask-bottom) + var(--nav-mask-radius)),0)}
        .nb-nav-motion-mask>[data-nav-mask="bottom-right"]{right:var(--nav-mask-right);bottom:var(--nav-mask-bottom);border-top-left-radius:var(--nav-mask-radius);transform:translate3d(calc(var(--nav-mask-right) + var(--nav-mask-radius)),calc(var(--nav-mask-bottom) + var(--nav-mask-radius)),0)}
