...
for (const [label, input] of [["v4", legacy], ["v5", v5], ["v6", v6], ["v7", v7]]) {
  test(`normalizes ${label} imports to validated v7 state`, () => {
...
test("creates a valid empty v7 notebook while preserving device preferences", () => {
